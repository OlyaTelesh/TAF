...
public class BrowsersService {
    ...
    public WebDriver getDriver() {
        driver.manage().window().maximize(); //специальные методы для принудительных действий
        driver.manage().deleteAllCookies(); //можно не делать при испольховании инкогнито
